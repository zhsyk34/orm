...
public class JpaBaseDao<E, K> {
	...
	*//**
	 * Returns all rows ordered by the given set of entity attribues.
	 *
	 * @param order         You may pass in an array of attributes and a order by clause
	 *                      will be added for each attribute in turn e.g. order by
	 *                      order[0], order[1] ....
	 * @param sortAscending An array of booleans that must be the same size as the order.
